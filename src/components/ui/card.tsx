...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[1.75rem] border border-white/60 bg-white/70 p-px text-card-foreground shadow-[0_30px_70px_rgba(15,23,42,0.14)] backdrop-blur-2xl transition-all duration-500 ease-out hover:-translate-y-0.5 dark:border-white/10 dark:bg-white/10",
      className,
    )}
    {...props}
  />
